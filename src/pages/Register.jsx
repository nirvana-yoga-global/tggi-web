...
function SuccessScreen({ fullName, plantName }) {
  return (
    <div className="flex flex-col items-center text-center py-10 px-4">
      {/* SVG leaf draw animation */}
      <div className="mb-8" aria-hidden="true">
        ...
        >
          {/* Leaf outline — pathLength=1 normalises dash values */}
          <path
            ...
            style={{
              strokeDashoffset: 1,
              animation: 'leaf-outline-draw 2s cubic-bezier(0.4,0,0.2,1) 0.1s forwards',
            }}
          />
          {/* Midrib vein */}
          <line
            ...
            style={{
              strokeDashoffset: 1,
              animation: 'leaf-outline-draw 1.4s cubic-bezier(0.4,0,0.2,1) 1s forwards',
            }}
          />
          {/* Side veins — fade in */}
          {[
            ...
            return (
              <line
                ...
                strokeOpacity="0"
                style={{
                  animation: `leaf-vein-fade 0.6s ease-out ${1.6 + i * 0.08}s forwards`,
                }}
              />
            )
          })}
      ...
      <h2
        className="font-serif font-semibold text-forest leading-[1.1] mb-5"
      ...
      <p
        className="font-sans text-forest/75 leading-relaxed max-w-md mb-10"
        style={{ fontSize: 'clamp(1rem, 2vw, 1.2rem)' }}
      >
        Thank you,{' '}
        <strong className="text-forest font-semibold">{fullName}</strong>.
        Your{' '}
        <em>{plantName}</em>{' '}
        has been registered. We'll be cheering for every leaf.
      </p>
...
export default function Register() {
  ...
  async function handleSubmit(evt) {
    ...
    if (!supabase) {
      setSubmitError('Supabase is not configured yet. Add your VITE_SUPABASE_URL and VITE_SUPABASE_ANON_KEY to .env and restart the dev server.')
      return
    }
    ...
    <div className="min-h-screen bg-cream pt-20">
      <div className="max-w-xl mx-auto px-6 py-12 sm:py-16">
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <Field
            label="Email Address"
            hint="Optional — for monthly reminders."
            error={errors.email}
          >
            <input
              type="email"
          ...
          {/* 4. Plant Nickname */}
          <Field
            label="What will you call your plant?"
            required
          ...
          {/* 7. First Photo */}
          <Field
            label="Upload your first photo of the plant"
            required
            error={errors.first_photo}
          >
            <label
              className={`
                ...
                ${errors.first_photo
                  ? 'border-terracotta'
                  : 'border-forest/25 hover:border-forest/55'}
              `}
            ...
            >
              ...
              <svg
                ...
                className="text-forest/45 flex-shrink-0"
                aria-hidden="true"
              >
          ...
          <div className="mb-9">
            ...
            >
              ...
              <span className="font-sans text-forest text-lg leading-relaxed">
                I commit to nurturing this plant and sharing monthly photo
                updates
          ...
          {submitError && (
            <div
              ...
              style={{
                backgroundColor: 'rgba(196,98,61,0.07)',
                borderColor: 'rgba(196,98,61,0.3)',
              }}
            >
              <p className="font-sans text-terracotta text-base leading-relaxed">
                ⚠ {submitError}
              </p>
            </div>
          )}
